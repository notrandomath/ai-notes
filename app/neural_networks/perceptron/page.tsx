...
export default function PerceptronPage() {
  return (
    <div className="flex flex-col items-center my-[25px] space-y-[25px]">
        ...
        <TextBox>
          <h3>Introduction</h3>
          <p>If we are thinking of a neural network as a graph, the perceptron is like a node or a vertex of the graph. A perceptron is also the "neuron" in the neural network.</p>
